...
$(function(){$(".partners").owlCarousel({loop:!0,smartSpeed:700,dots:!1,nav:!0,responsiveClass:!0,responsive:{0:{items:1},768:{items:2},992:{items:3},1200:{items:4}}}),$(".timer").appear(function(){$(this).countTo()}),$(".scrollspy").scrollSpy(),$("form.callback").submit(function(){var s=$(this);return $.ajax({type:"POST",url:"mail.php",data:s.serialize()}).done(function(){$(s).find(".success").addClass("active").css("display","flex").hide().fadeIn(),setTimeout(function(){$(s).find(".success").removeClass("active").fadeOut(),s.trigger("reset")},3e3)}),!1})});